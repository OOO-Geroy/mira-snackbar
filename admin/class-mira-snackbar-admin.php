 ...
 * @subpackage Mira_Snackbar/admin
 */
...
class Mira_Snackbar_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/mira-snackbar-admin.js', array( 'jquery' ), $this->version, false );
